...
+ substring（开始索引，结束索引）：从开始索引截取到结束索引（不包含最后元素）。
  ...
  ![subString3](https://cdn.jsdelivr.net/gh/TCIano/blog_img/image-20220911195719578.png)
  ...
  ![subString3](https://cdn.jsdelivr.net/gh/TCIano/blog_img/image-20220911194727837.png)

  ![subString1结果](https://cdn.jsdelivr.net/gh/TCIano/blog_img/image-20220911194810893.png)
